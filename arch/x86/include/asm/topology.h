...
#ifdef CONFIG_SCHED_MC_IPCC
void intel_itd_clear_history(void);
#else
static inline void intel_itd_clear_history(void) { }
#endif
...
static inline int intel_hfi_get_ipcc_baseline(int cpu) { return 1; }
#endif
